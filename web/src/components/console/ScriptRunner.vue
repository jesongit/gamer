<template>
  ...
  <div v-else class="script-edit">
    ...
    <div class="edit-actions">
      ...
      <button class="btn" :class="{ active: ctx.altMode }" @click="ctx.toggleAltMode" title="开启后投屏点击/滑动与模板 Alt 点击生成类型化步骤插入当前锚点">⌥ alt 模式</button>
