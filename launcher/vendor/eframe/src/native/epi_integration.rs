...
impl EpiIntegration {
    ...
    pub fn new(
        ...
        Self {
            ...
            // Gamer: do not override an explicitly hidden root viewport on first paint.
            // Visible(true) commands still reveal it when installation or user input needs it.
            is_first_frame: native_options.viewport.visible.unwrap_or(true),
            egui_ctx,
        }
    }
