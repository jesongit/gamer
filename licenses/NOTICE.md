...
| FFmpeg / FFprobe | ffmpeg.exe + ffprobe.exe（BtbN win64-lgpl 静态构建） | N-126335-gb32f8d1c23-20260830 | https://github.com/BtbN/FFmpeg-Builds/releases/download/latest/ffmpeg-master-latest-win64-lgpl.zip | LGPL-3.0-or-later | FFmpeg contributors（构建: BtbN/FFmpeg-Builds） | [ffmpeg/](./ffmpeg/) |
